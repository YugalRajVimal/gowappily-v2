...
const ContactUs = () => {
  ...
  const headingText = darkMode ? "text-gray-100" : "text-gray-800";
  ...
  return (
    ...
    //   </section>
    // </section>
    <section id="about" className={`py-16 relative min-h-screen ${bgSection}`}>
      {/* Custom Alert */}
      {alert && (
        <div
          className={`fixed top-5 right-5 z-50 px-6 py-4 rounded-lg shadow-lg transition-transform transform ${
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2
                className={`text-sm uppercase tracking-widest text-danger mb-4 font-montserrat ${subText}`}
              >
                Get in Touch
              </h2>
              <h3
                className={`text-3xl md:text-4xl font-bold font-montserrat mb-6 tracking-tight ${headingText}`}
              >
                Let's Start a Conversation
              </h3>
              <p className={`${subText} font-roboto mb-8`}>
                Whether you have a project in mind or just want to explore
                possibilities, we're here to help. Fill out the form, and one of
                our team members will get back to you shortly.
              </p>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      value={fullName}
                      onChange={(e) => setFullName(e.target.value)}
                      className={`w-full ${inputBg} border ${borderColor} px-4 py-2 rounded-md focus:outline-none transition duration-300`}
                    />
                  </div>
                ...
                <div className="grid md:grid-cols-[150px_1fr] gap-6">
                  <div>
                    ...
                    <select
                      value={countryCode}
                      onChange={(e) => setCountryCode(e.target.value)}
                      className={`w-full ${inputBg} border ${borderColor} px-4 py-2 rounded-md transition duration-300`}
                    >
                      <option value="+91">India (+91)</option>
                      <option value="+1">USA (+1)</option>
                      <option value="+44">UK (+44)</option>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    value={message}
                    onChange={(e) => setMessage(e.target.value)}
                    className={`w-full ${inputBg} border ${borderColor} px-4 py-2 rounded-md focus:outline-none resize-none transition duration-300`}
                  ></textarea>
                </div>

                <button
                  type="submit"
                  className={`w-full mt-4 flex items-center justify-center gap-5 border ${darkMode?"hover:bg-white hover:text-black":"hover:bg-black hover:text-white "} ${borderColor} ${headingText}  px-5 py-2 rounded-md transition-all duration-300`}
                >
                  <FiSend size={15} />
                  <span className="font-semibold text-sm">Send Message</span>
                </button>
            ...
            <div
              className={`${cardBg} rounded-lg border ${borderColor} shadow-gold p-8 md:p-12`}
            >
              <h3
                className={`text-2xl font-bold font-montserrat mb-8 tracking-tight ${headingText}`}
              >
                Contact Information
              </h3>
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <a
                        href={`mailto:${contactInfo.email}`}
                        className={`${subText} font-roboto transition hover:text-danger`}
                      >
                        {contactInfo.email}
                      </a>
                    </div>
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className={`${subText} font-roboto`}>
                        {contactInfo.location.address1}
                      </p>
                    </div>
                  </div>
