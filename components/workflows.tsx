        ...
        <div className="pb-12 md:pb-20">
          ...
          <Spotlight className="group mx-auto flex justify-center gap-4  flex-wrap w-full  items-start gap-6 lg:max-w-none ">
            ...
            <a
              ...
              href="#0"
            >
              <div className="relative z-20 h-full flex flex-col overflow-hidden rounded-[inherit] bg-gray-950">
                {/* Image */}
                <img
                  src={WorflowImg01}
                  width={350}
            ...
            >
              <div className="relative z-20 h-full flex flex-col overflow-hidden rounded-[inherit] bg-gray-950">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    GoWappily Infotech delivers performance-driven marketing
                    solutions focused on maximizing ROI. Our services specialize
                    in paid media campaigns across Google Ads and Meta
                    platforms, strategically optimized to drive conversions,
                    leads, and sales. Backed by data analytics and continuous
                    A/B testing, we build scalable campaigns that align with
                    your business goals. Whether you're looking to increase
                    traffic, boost app installs, or generate qualified leads,
                    our targeted approach ensures every marketing dollar
            ...
            >
              <div className="relative z-20 h-full flex flex-col overflow-hidden rounded-[inherit] bg-gray-950">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    GoWappily Infotech helps brands grow and engage their
                    audience through strategic social media marketing. We craft
                    platform-specific campaigns for Facebook, Instagram,
                    Twitter, and LinkedIn—designed to boost brand awareness,
                    drive quality traffic, and build a loyal community. From
                    content creation and audience engagement to ad campaign
                    management and performance analytics, we ensure your brand
                    stays relevant and impactful—turning followers into
                    customers and engagement into business growth.
                  </p>
                </div>
              </div>
            </a>
