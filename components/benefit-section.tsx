    ...
    <section id="benefits" className="py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="animate-[gradient_6s_linear_infinite] dark:bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[linear-gradient(to_right,var(--color-gray-800),var(--color-indigo-800),var(--color-gray-50),var(--color-indigo-900),var(--color-gray-800))] bg-[length:200%_auto] bg-clip-text pb-5 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
            Why Choose GoWappily Infotech?
          </h2>
